...
namespace Upload.Actions
{
    public class MainActions
    {
        ...
        public void ShowMainWindow(object obj)
        {
        ...
        private void LicenseWindowCmdInvoke(object obj)
        {
            ...
            ActivationActions activateActions = new ActivationActions(PRODUCT_ID);
            activateActions.ShowMainWindow = new Miscellaneous.RelayCommand(ShowMainWindow);
            activateActions.ShowActivationForm(keyInfo, purchaseOptions);
            if (mainWnd != null)
            {
                mainWnd.Close();
            }
